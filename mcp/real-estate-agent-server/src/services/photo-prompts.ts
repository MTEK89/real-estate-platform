...
const STAGING_STYLE_NOTES: Record<VirtualStagingStyle, string> = {
...
const HEADSHOT_STYLE_PROMPTS: Record<HeadshotStyleId, string> = {
...
const HEADSHOT_OUTFIT_PROMPTS: Record<HeadshotOutfitId, string> = {
...
export function renderDeclutterPrompt(): string {
...
export function renderRemovePersonalItemsPrompt(): string {
  return `MODE: edit / inpaint (semantic)
...
export function renderDayToTwilightPrompt(): string {
...
export function renderSkyReplacementPrompt(): string {
  return `MODE: edit / inpaint (semantic)
...
export function renderVirtualRenovationPrompt(renovationRequest: string): string {
...
export function renderBrightenPrompt(): string {
...
export function renderStraightenPrompt(): string {
...
export function renderRemoveCarsPeoplePrompt(): string {
  return `MODE: edit / inpaint (semantic)
...
export function renderEnhanceLandscapingPrompt(): string {
...
export function renderRemovePowerLinesPrompt(): string {
  return `MODE: edit / inpaint (semantic)
...
export function renderPoolCleanupPrompt(): string {
 ...
 */
export function renderEnhancePrompt(adjustments?: string[]): string {
 ...
 * Green grass prompt
 */
export function renderGreenGrassPrompt(intensity: string = "natural"): string {
  return `MODE: edit / targeted enhancement
 ...
 */
export function renderRemoveObjectPrompt(objectToRemove: string, fillWith: string = "auto"): string {
  return `MODE: edit / inpaint (semantic)
 ...
 * Pool water prompt
 */
export function renderPoolWaterPrompt(color: string = "crystal_blue"): string {
  return `MODE: edit / targeted enhancement
 ...
 */
export function renderAddFirePrompt(intensity: string = "moderate"): string {
  return `MODE: edit / inpaint (semantic)
 ...
 */
export function renderAddTvContentPrompt(contentType: string = "nature"): string {
 ...
 */
export function renderBrightenDarkenPrompt(adjustment: string, intensity: string = "moderate"): string {
