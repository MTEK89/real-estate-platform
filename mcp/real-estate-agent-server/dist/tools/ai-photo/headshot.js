 ...
 */
export function registerHeadshotTools(server) {
    server.tool("re_generate_headshot", `Generate a professional real estate agent headshot from a casual photo.
...
- "Make a corporate headshot for my business card"`, {
        ...
        try {
            ...
            return createSuccessResponse(`# Professional Headshot Generated!\n\n` +
                `**Style**: ${args.style}\n` +
    ...
    // Quick headshot
    server.tool("re_quick_headshot", `Quickly generate a classic professional headshot.
