...
import { renderDayToTwilightPrompt, renderDeclutterPrompt, renderEnhancePrompt, renderSkyReplacementPrompt, renderGreenGrassPrompt, renderRemoveObjectPrompt, renderPoolWaterPrompt, renderAddFirePrompt, renderAddTvContentPrompt, renderBrightenDarkenPrompt, } from "../../services/photo-prompts.js";
 ...
 */
export function registerPhotoEditTools(server) {
    // Day to Twilight
    server.tool("re_day_to_twilight", `Transform a daytime exterior photo into a stunning twilight/dusk shot.
...
- "Add evening ambiance"`, {
        ...
        try {
            ...
            return createSuccessResponse(`# Twilight Conversion Complete!\n\n` +
    ...
    // Declutter
    server.tool("re_declutter", `Remove clutter and personal items from property photos.
...
- "Clean up the living room photo"`, {
        ...
        try {
            ...
            return createSuccessResponse(`# Declutter Complete!\n\n` +
                `**Level**: ${args.level}\n` +
                `**Result**: ${result.images[0].url}\n\n` +
    ...
    // Enhance photo
    server.tool("re_enhance_photo", `Enhance property photo quality with professional adjustments.
...
- "Improve the image quality"`, {
        ...
        try {
            ...
            return createSuccessResponse(`# Photo Enhanced!\n\n` +
    ...
    // Sky replacement
    server.tool("re_sky_replacement", `Replace overcast or dull skies with beautiful alternatives.
...
- "Make the sky more dramatic"`, {
        ...
        try {
            ...
            return createSuccessResponse(`# Sky Replaced!\n\n` +
    ...
    // Green grass
    server.tool("re_green_grass", `Make brown or patchy grass look lush and green.
...
- "Make the garden look better"`, {
        ...
        try {
            ...
            return createSuccessResponse(`# Grass Greened!\n\n` +
                `**Intensity**: ${args.intensity}\n` +
                `**Result**: ${result.images[0].url}\n\n` +
    ...
    // Remove object
    server.tool("re_remove_object", `Remove unwanted objects from property photos.
...
- "Remove the ladder from the photo"`, {
        ...
        try {
            ...
            return createSuccessResponse(`# Object Removed!\n\n` +
    ...
    server.tool("re_pool_water", `Make pool water look crystal clear and inviting.
...
- "Make the pool look inviting"`, {
        ...
        try {
            ...
            return createSuccessResponse(`# Pool Water Enhanced!\n\n` +
    ...
    server.tool("re_add_fire", `Add realistic flames to an empty fireplace.
...
- "Make the fireplace look cozy"`, {
        ...
        try {
            ...
            return createSuccessResponse(`# Fire Added!\n\n` +
                `**Intensity**: ${args.intensity}\n` +
                `**Result**: ${result.images[0].url}\n\n` +
    ...
    // Add TV content
    server.tool("re_add_tv_content", `Add attractive content to blank TV screens.
...
- "Make the TV screen look good"`, {
        ...
        try {
            ...
            return createSuccessResponse(`# TV Content Added!\n\n` +
    ...
    // Brighten/darken
    server.tool("re_adjust_lighting", `Brighten dark rooms or balance overexposed areas.
...
- "Balance the lighting"`, {
        ...
        try {
            ...
            return createSuccessResponse(`# Lighting Adjusted!\n\n` +
...
//# sourceMappingURL=photo-edits.js.map