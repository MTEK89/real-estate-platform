 ...
 */
export function getFalNotConfiguredMessage() {
 ...
 */
export function getContactNotFoundMessage(query, suggestions) {
 ...
 */
export function getPropertyNotFoundMessage(query, suggestions) {
    if (suggestions && suggestions.length > 0) {
 ...
 */
export function getRequiredFieldsMessage(fields) {
